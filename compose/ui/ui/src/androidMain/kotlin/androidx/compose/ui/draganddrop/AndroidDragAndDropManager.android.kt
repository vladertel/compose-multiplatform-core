...
internal class AndroidDragAndDropManager(
     ...
     * drop session by returning true in [DragAndDropNode.onStarted].
     */
    private val interestedNodes = ArraySet<DragAndDropNode>()
    ...
    override val startTransferRequester: ((DragAndDropNode, Offset) -> Unit)
        get() = { node, offset ->
            with(node) {

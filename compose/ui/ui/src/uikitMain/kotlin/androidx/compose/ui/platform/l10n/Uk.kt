...
internal fun Translations.uk() = mapOf(
    Strings.NextPage to "Наступна сторінка",
    Strings.PreviousPage to "Попередня сторінка",
    Strings.FirstPage to "Перша сторінка",
    Strings.LastPage to "Остання сторінка",
)

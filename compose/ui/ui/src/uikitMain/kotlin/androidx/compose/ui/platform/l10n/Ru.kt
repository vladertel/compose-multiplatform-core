...
internal fun Translations.ru() = mapOf(
    Strings.NextPage to "Следующая страница",
    Strings.PreviousPage to "Предыдущая страница",
    Strings.FirstPage to "Первая страница",
    Strings.LastPage to "Последняя страница",
)

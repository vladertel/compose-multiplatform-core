...
internal fun Translations.ms() = mapOf(
    Strings.NextPage to "Muka surat seterusnya",
    Strings.PreviousPage to "Halaman sebelumnya",
    Strings.FirstPage to "Muka surat pertama",
    Strings.LastPage to "Muka surat terakhir",
)

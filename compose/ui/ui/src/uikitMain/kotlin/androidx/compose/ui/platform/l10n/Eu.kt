...
internal fun Translations.eu() = mapOf(
    Strings.NextPage to "Hurrengo orrialdea",
    Strings.PreviousPage to "Aurreko orrialdea",
    Strings.FirstPage to "Lehen orrialdea",
    Strings.LastPage to "Azken orrialdea",
)

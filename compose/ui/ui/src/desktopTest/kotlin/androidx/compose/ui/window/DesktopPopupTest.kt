...
class DesktopPopupTest {
    ...
    @Test
    fun `call dismiss if clicked outside of focusable popup`() = ImageComposeScene(100, 100).use { scene ->
    ...
    @Test
    fun `pass event if clicked outside of non-focusable popup`() = ImageComposeScene(100, 100).use { scene ->
        var onDismissRequestCallCount = 0

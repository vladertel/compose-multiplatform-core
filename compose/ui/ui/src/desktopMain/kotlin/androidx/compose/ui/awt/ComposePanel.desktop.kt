...
class ComposePanel @ExperimentalComposeUiApi constructor(
    ...
    override fun remove(component: Component) {
        _composeContainer?.removeFromComponentLayer(component)
    ...
    override fun addNotify() {
        ...
        // content.
        _composeContainer ?: createComposeContainer().also {
    ...
    private fun createComposeContainer(): ComposeContainer {
        return ComposeContainer(
            ...
            createSkiaLayerComponent = if (ComposeFeatureFlags.useSwingGraphics) {

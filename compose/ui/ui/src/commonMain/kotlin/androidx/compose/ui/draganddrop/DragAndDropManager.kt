...
interface DragAndDropManager {
    ...
    fun requestDragAndDropTransfer(node: DragAndDropRequesterModifierNode, offset: Offset): Unit =
        throw UnsupportedOperationException(
            "requestDragAndDropTransfer is not implemented on this DragAndDropManager"
        )

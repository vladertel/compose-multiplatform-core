...
interface Clipboard {
     ...
     */
    @Suppress("GetterSetterNames") suspend fun setText(annotatedString: AnnotatedString)
     ...
     * platforms.
     */
    suspend fun getClip(): ClipEntry? = null
     ...
     */
    @Suppress("GetterSetterNames") suspend fun setClip(clipEntry: ClipEntry?) = Unit

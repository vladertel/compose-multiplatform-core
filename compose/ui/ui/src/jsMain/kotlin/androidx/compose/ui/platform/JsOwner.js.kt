...
/* internal */ class JsOwner(
    val container: JsOwners,
    ...
    override val hapticFeedBack = JsHapticFeedback()

    override val clipboardManager = JsClipboardManager()

    override val accessibilityManager = JsAccessibilityManager()

    override val textToolbar = JsTextToolbar()
    ...
    override val viewConfiguration: ViewConfiguration = JsViewConfiguration(density)

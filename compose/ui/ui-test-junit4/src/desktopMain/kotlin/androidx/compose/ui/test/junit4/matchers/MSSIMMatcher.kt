...
// Adopted copy of test/screenshot/screenshot/src/main/java/androidx/test/screenshot/matchers/MSSIMMatcher.kt
 ...
 */
internal class MSSIMMatcher(@FloatRange(from = 0.0, to = 1.0) private val threshold: Double) :
    BitmapMatcher {

...
// Adopted copy of test/screenshot/screenshot/src/main/java/androidx/test/screenshot/matchers/BitmapMatcher.kt
 ...
 *   was found.
 */
internal class MatchResult(val matches: Boolean, val comparisonStatistics: String, val diff: IntArray?)

...
// import org.jetbrains.skiko.skia.native.ColorFilter as SkiaColorFilter

// TODO: remove me.
class NativeColorFilterStub

actual typealias NativeColorFilter = NativeColorFilterStub // SkijaColorFilter
...
internal actual fun actualTintColorFilter(color: Color, blendMode: BlendMode): ColorFilter =
    TODO("implement actualTintColorFilter")
...
internal actual fun actualColorMatrixColorFilter(colorMatrix: ColorMatrix): ColorFilter =
    TODO("implement actualColorMatrixColorFilter")
    /*
    ColorFilter(
...
internal actual fun actualLightingColorFilter(multiply: Color, add: Color): ColorFilter =
    TODO("implement actualLightingColorFilter")

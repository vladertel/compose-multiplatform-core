...
internal actual fun actualCornerPathEffect(radius: Float): PathEffect =
    TODO("implement native actualCornerPathEffect")
...
internal actual fun actualDashPathEffect(
    ...
    TODO("implement native actualDashPathEffect")
    //DesktopPathEffect(SkijaPathEffect.makeDash(intervals, phase))

internal actual fun actualChainPathEffect(outer: PathEffect, inner: PathEffect): PathEffect =
    TODO("implement native actualChainPathEffect")
...
internal actual fun actualStampedPathEffect(
    ...
    TODO("implement native actualStampedPathEffect")
    /*
    DesktopPathEffect(

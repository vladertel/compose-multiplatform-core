...
internal expect class ComposableLambdaImpl(
    ...
    override fun invoke(p1: Any?, c: Composer, changed: Int): Any?
    override fun invoke(p1: Any?, p2: Any?, c: Composer, changed: Int): Any?
    override fun invoke(p1: Any?, p2: Any?, p3: Any?, c: Composer, changed: Int): Any?
    override fun invoke(p1: Any?, p2: Any?, p3: Any?, p4: Any?, c: Composer, changed: Int): Any?
    override fun invoke(
        p1: Any?,
        p2: Any?,
        p3: Any?,

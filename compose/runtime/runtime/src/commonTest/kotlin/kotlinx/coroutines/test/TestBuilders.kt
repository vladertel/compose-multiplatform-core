...
// * ```
// * @Test
// * fun exampleTest() = kotlinx.coroutines.test.runBlockingTest {
// *     val deferred = async {
// *         delay(1_000)
// *         async {
// *             delay(1_000)
...
//        this?.let { require(this is DelayController) { "Dispatcher must implement kotlinx.coroutines.test.DelayController: $this" } }

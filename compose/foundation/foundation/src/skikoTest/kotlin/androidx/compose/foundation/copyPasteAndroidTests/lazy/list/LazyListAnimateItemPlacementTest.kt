...
class LazyListAnimateItemPlacementTest {
    ...
    @Test
    fun reorderTwoItems() = runParametrizedTest { 
    ...
    @Test
    fun reorderTwoItems_layoutInfoHasFinalPositions() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1))
        setContent {
            LazyList {
                items(list, key = { it }) {
    ...
    @Test
    fun reorderFirstAndLastItems() = runParametrizedTest {
    ...
    @Test
    fun moveFirstItemToEndCausingAllItemsToAnimate() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4))
        setContent {
            LazyList {
                items(list, key = { it }) {
    ...
    @Test
    fun itemSizeChangeAnimatesNextItems() = runParametrizedTest {
    ...
    @Test
    fun onlyItemsWithModifierAnimates() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4))
        setContent {
            LazyList {
                items(list, key = { it }) {
    ...
    @Test
    fun animationsWithDifferentDurations() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4))
        setContent {
            LazyList {
                items(list, key = { it }) {
    ...
    @Test
    fun multipleChildrenPerItem() = runParametrizedTest {
    ...
    @Test
    fun multipleChildrenPerItemSomeDoNotAnimate() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 2))
        setContent {
            LazyList {
                items(list, key = { it }) {
    ...
    @Test
    fun animateArrangementChange() = runParametrizedTest {
    ...
    @Test
    fun moveItemToTheBottomOutsideOfBounds() = runParametrizedTest {
        ...
        onAnimationFrame { fraction ->
            ...
            val expected = mutableListOf<Pair<Any, Int>>().apply {
                ...
                if (item1Offset < itemSize * 3) {
                    ...
                    onNodeWithTag("1").assertIsNotDisplayed()
                }
                add(2 to itemSize * 2)
                if (item4Offset < itemSize * 3) {
                    add(4 to item4Offset)
                } else {
                    onNodeWithTag("4").assertIsNotDisplayed()
                }
            }
            assertPositions(
    ...
    @Test
    fun moveItemToTheTopOutsideOfBounds() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4, 5))
        setContent {
    ...
    @Test
    fun moveItemToTheTopOutsideOfBounds_withStickyHeader() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4))
        setContent {
    ...
    @Test
    fun moveFirstItemToEndCausingAllItemsToAnimate_withSpacing() = runParametrizedTest {
    ...
    @Test
    fun moveItemToTheBottomOutsideOfBounds_withSpacing() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4, 5))
        setContent {
            LazyList(
    ...
    @Test
    fun moveItemToTheTopOutsideOfBounds_withSpacing() = runParametrizedTest {
    ...
    @Test
    fun moveItemToTheTopOutsideOfBounds_differentSizes() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4, 5))
        setContent {
    ...
    @Test
    fun moveItemToTheBottomOutsideOfBounds_differentSizes() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4, 5))
        val listSize = itemSize2 + itemSize3 + itemSize - 1
        val listSizeDp = with(density) { listSize.toDp() }
        setContent {
    ...
    @Test
    fun animateAlignmentChange() = runParametrizedTest {
    ...
    @Test
    fun animateAlignmentChange_multipleChildrenPerItem() = runParametrizedTest {
    ...
    @Test
    fun animateAlignmentChange_rtl() = runParametrizedTest {
        // this test is not applicable to LazyRow
        if (!isVertical) return@runParametrizedTest
    ...
    @Test
    fun moveItemToEndCausingNextItemsToAnimate_withContentPadding() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4))
        val rawStartPadding = 8
        val rawEndPadding = 12
        val (startPaddingDp, endPaddingDp) = with(density) {
    ...
    @Test
    fun reorderFirstAndLastItems_noNewLayoutInfoProduced() = runParametrizedTest {
        var list by mutableStateOf(listOf(0, 1, 2, 3, 4))
    ...
    @Test
    fun noAnimationWhenScrollOtherPosition() = runParametrizedTest {
    ...
    @Test
    fun noAnimationWhenScrollForwardBySmallOffset() = runParametrizedTest {
        lateinit var scope: CoroutineScope
        setContent {
            scope = rememberCoroutineScope()
            LazyList(maxSize = itemSizeDp * 3) {
    ...
    @Test
    fun noAnimationWhenScrollBackwardBySmallOffset() = runParametrizedTest {
        lateinit var scope: CoroutineScope
        setContent {
            scope = rememberCoroutineScope()
    ...
    @Test
    fun noAnimationWhenScrollForwardByLargeOffset() = runParametrizedTest {
        lateinit var scope: CoroutineScope
        setContent {
            scope = rememberCoroutineScope()
            LazyList(maxSize = itemSizeDp * 3) {
    ...
    @Test
    fun noAnimationWhenScrollBackwardByLargeOffset() = runParametrizedTest {
        lateinit var scope: CoroutineScope
        setContent {
            scope = rememberCoroutineScope()
    ...
    @Test
    fun noAnimationWhenScrollForwardByLargeOffset_differentSizes() = runParametrizedTest {
        lateinit var scope: CoroutineScope
        setContent {
            scope = rememberCoroutineScope()
            LazyList(maxSize = itemSizeDp * 3) {
    ...
    @Test
    fun noAnimationWhenScrollBackwardByLargeOffset_differentSizes() = runParametrizedTest {
        lateinit var scope: CoroutineScope
        setContent {
            scope = rememberCoroutineScope()
            LazyList(maxSize = itemSizeDp * 3, startIndex = 3) {
    ...
    private fun SkikoComposeUiTest.assertPositions(
        ...
        with(density) {
            val actual = expected.map {
                val actualOffset = onNodeWithTag(it.first.toString())
    ...
    private fun SkikoComposeUiTest.assertLayoutInfoPositions(vararg offsets: Pair<Any, Int>) {
        runOnIdle {
    ...
    private fun SkikoComposeUiTest.onAnimationFrame(duration: Long = Duration, onFrame: (fraction: Float) -> Unit) {
        require(duration.mod(FrameDuration) == 0L)
        waitForIdle()
        mainClock.advanceTimeByFrame()
        var expectedTime = mainClock.currentTime
        for (i in 0..duration step FrameDuration) {
            onFrame(i / duration.toFloat())
            mainClock.advanceTimeBy(FrameDuration)
            expectedTime += FrameDuration
            assertThat(expectedTime).isEqualTo(mainClock.currentTime)
            waitForIdle()
        }
    }

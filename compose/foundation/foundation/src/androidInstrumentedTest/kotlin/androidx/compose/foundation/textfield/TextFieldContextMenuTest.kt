...
class TextFieldContextMenuTest : FocusedWindowTest {
    ...
    @Test
    fun btf1_contextMenu_onClickCut() = runTest {
    ...
    @Test
    fun btf1_contextMenu_onClickCopy() = runTest {
        runBtf1ClickContextMenuItemTest(
    ...
    @Test
    fun btf1_contextMenu_onClickPaste() = runTest {
        runBtf1ClickContextMenuItemTest(
    ...
    @Test
    fun btf1_contextMenu_onClickSelectAll() = runTest {
        runBtf1ClickContextMenuItemTest(
    ...
    @Test
    fun btf1_contextMenu_emptyClipboard_noSelection_itemsMatch() = runTest {
    ...
    @Test
    fun btf1_contextMenu_nonEmptyClipboard_noSelection_itemsMatch() = runTest {
        runBtf1CorrectItemsTest(
    ...
    @Test
    fun btf1_contextMenu_password_noSelection_itemsMatch() = runTest {
        runBtf1CorrectItemsTest(
            isPassword = true,
            selectionAmount = SelectionAmount.NONE,
        ) {

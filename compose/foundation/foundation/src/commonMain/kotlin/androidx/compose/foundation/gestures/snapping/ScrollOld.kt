 ...
 */
@Composable
fun rememberScrollStateOld(initial: Int = 0): ScrollStateOld {
    return rememberSaveable(saver = ScrollStateOld.Saver) {
        ScrollStateOld(initial = initial)
    }
}
 ...
 */
@Stable
class ScrollStateOld(initial: Int) : ScrollableState {
    ...
    companion object {
         ...
         */
        val Saver: Saver<ScrollStateOld, *> = Saver(
            save = { it.value },
            restore = { ScrollStateOld(it) }
        )
    }
}
 ...
 */
fun Modifier.verticalScrollOld(
 ...
 */
fun Modifier.horizontalScrollOld(
    state: ScrollStateOld,
    enabled: Boolean = true,
    flingBehavior: FlingBehavior? = null,
    reverseScrolling: Boolean = false
...
private fun Modifier.scrollOld(
    state: ScrollStateOld,
    ...
    factory = {
        ...
        val scrolling = Modifier.scrollableOld(
...
internal class ScrollingLayoutElement(
    val scrollState: ScrollStateOld,
...
internal class ScrollingLayoutNode(
    var scrollerState: ScrollStateOld,

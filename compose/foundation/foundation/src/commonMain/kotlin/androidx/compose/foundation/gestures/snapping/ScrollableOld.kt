...
import androidx.compose.foundation.gestures.rememberFlingBehavior
...
private class ScrollableGesturesNode(
    ...
    val mouseWheelScrollNode = delegate(MouseWheelScrollNodeOld(scrollLogic, enabled))

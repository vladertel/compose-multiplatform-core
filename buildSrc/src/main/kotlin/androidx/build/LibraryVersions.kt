...
object LibraryVersions {
    val ACTIVITY = Version("1.1.0-rc01")
    ...
    val COMPOSE = Version("0.1.0-dev02")
    ...
    val FRAGMENT = Version("1.2.0-rc01")
    ...
    val LIFECYCLE = Version("2.2.0-rc01")
    val LIFECYCLE_EXTENSIONS = LIFECYCLE
    val LIFECYCLES_SAVEDSTATE = Version("1.0.0-rc01")
    ...
    val NAVIGATION = Version("2.2.0-rc04")
    ...
    val RECYCLERVIEW = Version("1.1.0-rc01")
    ...
    val TRANSITION = Version("1.3.0-rc01")
    val TVPROVIDER = Version("1.1.0-alpha01")
    val UI = Version("0.1.0-dev02")
    ...
    val VIEWPAGER2 = Version("1.0.0-rc01")

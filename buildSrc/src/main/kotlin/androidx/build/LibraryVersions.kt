...
object LibraryVersions {
    ...
    val CAMERA = Version("1.0.0-beta05")
    val CAMERA_EXTENSIONS = Version("1.0.0-alpha12")
    val CAMERA_PIPE = Version("1.0.0-alpha01")
    val CAMERA_VIEW = Version("1.0.0-alpha12")

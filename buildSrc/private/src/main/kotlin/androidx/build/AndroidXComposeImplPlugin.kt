...
class AndroidXComposeImplPlugin : Plugin<Project> {
    ...
    companion object {
        ...
        fun applyAndConfigureKotlinPlugin(
            ...
            project.tasks.withType(Kotlin2JsCompile::class.java).configureEach { compile ->
...
private fun configureComposeCompilerPlugin(
    ...
    project.afterEvaluate {
        ...
        val compilerPluginVersion = "2.0.10" //project.properties["jetbrains.compose.compiler.version"] as String

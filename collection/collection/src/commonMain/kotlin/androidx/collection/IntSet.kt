 ...
 *
 * Though [IntSet] offers a read-only interface, it is always backed
 * by a [MutableIntSet]. Read operations alone are thread-safe. However,
 * any mutations done through the backing [MutableIntSet] while reading
...
public sealed class IntSet {
    ...
    @PublishedApi
    @JvmField
    internal var elements: IntArray = EmptyIntArray
     ...
     */
    public inline fun first(): Int {
        forEach { return it }
        throw NoSuchElementException("The IntSet is empty")
    }
...
/**
 * [MutableIntSet] is a container with a [MutableSet]-like interface based on a flat
 ...
 *
 * @constructor Creates a new [MutableIntSet]
...
public class MutableIntSet(
    ...
    /**
     * Trims this [MutableIntSet]'s storage so it is sized appropriately
